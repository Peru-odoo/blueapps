odoo.define('asterisk_base.conf_template_widget', function (require) {
  "use strict";

  var field_registry = require('web.field_registry');
  var basicFields = require('web.basic_fields');

  var ConfTemplateField = basicFields.DebouncedField.extend({
    ...
    jsLibs: [
      ...
      [
        '/asterisk_base/static/lib/codemirror/mode/jinja2/jinja2.js',
  ...
  field_registry.add('conf_template', ConfTemplateField);
